...
cmd_opt.add_argument('-graph_fname', type=str)
cmd_opt.add_argument('-graph_type', type=int)
cmd_opt.add_argument('-num_graph', type=int)
cmd_opt.add_argument('-display_mode', type=int)
